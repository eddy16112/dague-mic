...
if(NOT PASTIX_DIR)
  ...
  set(PASTIX_INCLUDE_DIRS "${PASTIX_DIR}/include")
  set(PASTIX_LIBRARY_DIRS "${PASTIX_DIR}/lib")
...
set(PASTIX_LIBRARY_DIRS "${PASTIX_LIBRARY_DIRS}" CACHE PATH   "PaStiX libraries directories"   FORCE)
